...
Garages = {
    ["policetowngarage"] = {
        ...
        takeVehicle = vector3(371.07, -951.86, 29.37),
        spawnPoint = vector4(375.94, -957.25, 29.41, 268.95),
        putVehicle = vector3(360.92, -951.54, 29.42),
        showBlip = true,
    ...
    ["cityhallgarage"] = {
        ...
        takeVehicle = vector3(-298.19, -990.61, 31.08),
        spawnPoint = vector4(-295.15, -982.89, 31.08, 246.5),
        putVehicle = vector3(-304.69, -987.72, 31.08),
        showBlip = true,
        blipName = "Public Parking",
        blipNumber = 357,
        type = 'public',                --public, job, gang, depot
